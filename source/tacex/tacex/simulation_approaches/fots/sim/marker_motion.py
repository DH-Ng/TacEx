...
class MarkerMotion():
    ...
    def _motion_callback(self, marker_x_pos, marker_y_pos, depth_map, contact_mask, traj):
        ...
        new_x_pos, new_y_pos = self._dilate(self.lamb[0], marker_x_pos, marker_y_pos)
        if len(traj) >= 2:
            # under shear load
            ...
            new_x_pos, new_y_pos = self._twist(
