...
def _mk_taxim_torch(calib_folder: Path, params: Optional[Dict[str, Dict[str, Any]]], device: Optional[str]) \
        -> "TaximTorch":
    try:
        from .taxim_torch import TaximTorch
        import torch.cuda
...
def _mk_taxim_jax(calib_folder: Path, params: Optional[Dict[str, Dict[str, Any]]], device: Optional[str]) -> "TaximJax":
    try:
        from .taxim_jax import TaximJax
        import jax
...
@overload
def Taxim(calib_folder: Path = ..., params: Optional[Dict[str, Dict[str, Any]]] = ...,
          backend: Literal["torch"] = ...) -> "TaximTorch":
    ...


@overload
def Taxim(calib_folder: Path = ..., params: Optional[Dict[str, Dict[str, Any]]] = ...,
          backend: Literal["jax"] = ...) -> "TaximJax":
    ...


@overload
def Taxim(calib_folder: Path = ..., params: Optional[Dict[str, Dict[str, Any]]] = ...,
          backend: Literal["auto"] = ...) -> "Union[TaximTorch, TaximJax]":
    ...


def Taxim(calib_folder: Path = CALIB_GELSIGHT, params: Optional[Dict[str, Dict[str, Any]]] = None,
          backend: Literal["torch", "jax", "auto"] = "auto",
          device: Optional[str] = None) -> "Union[TaximTorch, TaximJax]":
    """
