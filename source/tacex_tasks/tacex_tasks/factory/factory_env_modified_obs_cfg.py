...
@configclass
class FactoryEnvModifiedObsCfg(DirectRLEnvCfg):
    decimation = 8
    action_space = 6
    ...
    sim: SimulationCfg = SimulationCfg(
        device="cuda:0",
        dt=1 / 120,  # with 1/30 does not work at all
    ...
    scene: InteractiveSceneCfg = InteractiveSceneCfg(
        num_envs=128, env_spacing=2.0, clone_in_fabric=True
    )
    ...
    ee_pos_offset = [0.0, 0.0, 0.107]  # [0.0, 0.0, 0.0]
...
@configclass
class FactoryTaskPegInsertModifiedObsCfg(FactoryEnvModifiedObsCfg):
...
@configclass
class FactoryTaskGearMeshModifiedObsCfg(FactoryEnvModifiedObsCfg):
    task_name = "gear_mesh"
    task = GearMesh()
...
@configclass
class FactoryTaskNutThreadModifiedObsCfg(FactoryEnvModifiedObsCfg):
